...
namespace Avalonia.Vulkan
{
    public class VulkanOptions
    {
        ...
        /// </summary>
        public Version VulkanVersion{ get; set; } =  new Version(1, 2, 0);
        
        /// <summary>
        /// Specifies additional extensions to enable if available on the instance
        /// </summary>
        public IList<string> AdditionalInstanceExtensions { get; set; } = new List<string>();
        
        /// <summary>
        /// Specifies additional extensions to enable if available on the logical device
        /// </summary>
        public IList<string> AdditionalDeviceExtensions { get; set; } = new List<string>();
